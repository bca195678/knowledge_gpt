...
# """
        """
# FAQ
## How does Alpha Intelligence GPT work?
I won't tell you.


## Is my data safe?
Yes. It is Local LLM server located inside Head Quarter of Alpha Networks Inc
and disconnected to the internet.

## Why does it take so long to index my document?
Because we don't have money for a faster server.
...
## Are the answers 100% accurate?
No, get a life if you think so.  Always check with the sources to make 
sure that the answers are correct.
